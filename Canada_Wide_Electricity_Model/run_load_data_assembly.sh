...
./AB_Spreadsheet_File.py -x Hourly-Metered-Volumes-and-Pool-Price-and-AIL-01-2008-10-2020.xlsx -a CSD-Assets.xlsx -g gen_db_AB_2019.txt -p gen_pv_AB_actual.txt -w gen_wind_AB_actual.txt > load_db_AB.txt
check_rc 'Alberta'
cd ..
